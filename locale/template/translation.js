export default {
    ...
    dCardOneDesc: '', //Create a new Seed2Need wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc: '', //Use your Ledger Hardware wallet with MSW's familiar interface.
    dCardThreeButton: '', //Access my Ledger

    dCardFourTitle: '', //Go to
    dCardFourSubTitle: '', //My Wallet
    dCardFourDesc: '', //Import a Seed2Need wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts: '', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving SILO easier!
    ...
    pivxPromos: '', // [...] is a decentralised system for gift codes worth SILO
    // NOTE: on this line, if possible, leave 'Seed2Need Promos' untranslated
    redeemInput: '', //Enter your 'Seed2Need Promos' code
    ...
    popupProposalFinalisedNote: '', //<b>Congratulations on launching your proposal!</b><br>Masternode owners can use your Vote Hash to vote from wallets other than MSW, so make sure to add this to your forum post, if applicable!
    popupProposalFinalisedSignoff: '', //Good luck on your journey through the DAO!
    ...
    BAD_ADDR_LENGTH: '', //<b>Invalid Seed2Need address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX: '', //<b>Invalid Seed2Need address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET: '', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Seed2Need app
